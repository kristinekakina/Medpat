...
class HosLicence : AppCompatActivity() {
    var mEdtTLicenceNumber2: EditText?= null
    var mEdtPhoneNumber2: EditText?= null
    var mBtnSend: Button?= null
    var mBtnBack: Button?= null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hos_licence)
        mEdtTLicenceNumber2 = findViewById(R.id.mEdtLicenceNumber2)
        mEdtPhoneNumber2 = findViewById(R.id.mEdtPhoneNumber2)
        ...
        mBtnSend!!.setOnClickListener{
            ...
            var message = mEdtTLicenceNumber2!!.text.toString()
...
//                }
            ...
            var message1 = mEdtPhoneNumber2!!.text.toString()
