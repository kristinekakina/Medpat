...
class PharLicence : AppCompatActivity() {
    var mEdtTLicenceNumber1: EditText?= null
    var mEdtPhoneNumber1: EditText?= null
    var mBtnSend: Button?= null
    var mBtnBack: Button?= null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_phar_licence)
        mEdtTLicenceNumber1 = findViewById(R.id.mEdtLicenceNumber2)
        mEdtPhoneNumber1 = findViewById(R.id.mEdtPhoneNumber2)
        ...
        mBtnSend!!.setOnClickListener{
            ...
            var message = mEdtTLicenceNumber1!!.text.toString()
...
//                }
            ...
            var message1 = mEdtPhoneNumber1!!.text.toString()
