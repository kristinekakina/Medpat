...
class CustomAdapterPat(var context: Context, var data:ArrayList<Doctor>):BaseAdapter() {
    private class ViewHolder(row:View?){
        ...
        init {
            ...
            this.messageButton = row?.findViewById(R.id.mBtnMessage) as Button
        }
    }
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null){
            ...
            view = layout.inflate(R.layout.pat_item_layout,parent,false)
        ...
        viewHolder.messageButton.setOnClickListener {
            context.startActivity(Intent(context,PatMessage::class.java))
        }
        return view as View
    }
